...
def receive_and_upload(host='127.0.0.3', port=65524):
    load_dotenv()
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket:
        ...
        mnemonic = "fold match coin hammer lazy velvet fringe ten remove bounce comic easy output bounce cute tuna puzzle hat debate concert hip jacket brain angry"
...
def store_and_measure_time(private_key, vehicle_data, counter):
    tag = "0x" + f"vehicle2_data#{counter}".encode("utf-8").hex()
